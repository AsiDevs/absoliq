...
const Tile = ({ tile, isSingleItem, idx }) => {
  return (
    ...
    >
      ...
      <p className="text-body-medium text-text-secondary transition-bouncy lg:opacity-0 lg:invisible lg:group-hover:opacity-100 lg:group-hover:visible pointer-events-none">
        {tile?.description}
      </p>
    </AnimateIn>
  );
